//! Shaded render pipeline - Blinn-Phong lighting

use wgpu::{BindGroupLayout, Device, RenderPipeline, TextureFormat};

use super::uniforms::{CameraBuffer, ModelBuffer};

/// Shaded rendering pipeline with basic lighting
pub struct ShadedPipeline {
...
impl ShadedPipeline {
    pub fn new(device: &Device, format: TextureFormat) -> Self {
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(include_str!("shaded.wgsl").into()),
        });
