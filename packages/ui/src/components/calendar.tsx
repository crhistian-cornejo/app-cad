...
import { Button, buttonVariants } from "@cadhy/ui/components/button"
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-3 [--cell-radius:var(--radius-2xl)] [--cell-size:--spacing(8)] bg-background group/calendar [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
