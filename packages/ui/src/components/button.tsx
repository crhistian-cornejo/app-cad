...
const buttonVariants = cva(
  ...
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none transform-gpu transition-all duration-150 ease-out hover:scale-[1.02] active:scale-[0.98] active:duration-75",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        "icon-xs":
          "size-6 rounded-md in-data-[slot=button-group]:rounded-md [&_svg:not([class*='size-'])]:size-3 hover:scale-105 active:scale-95",
        "icon-sm":
          "size-8 rounded-md in-data-[slot=button-group]:rounded-md hover:scale-105 active:scale-95",
